...
# (comma-separated for KWin). Dolphin's decoration is the primary target;
# add others (e.g. "alacritty") via FORCEBLUR_CLASSES if this system also
# force-blurs a terminal.
FORCEBLUR_CLASSES="${FORCEBLUR_CLASSES:-dolphin}"
